...
1. Create your own private copy of the assignment repository from
   ...
   repository for 'Assignment 01: Hypothetical Machine Simulator' at

   https://github.com/ahmet-kurt/csci430-assg01

   and select "Use this template" -> "Create a new repository".  Make
   sure the owner is your own GitHub account, name your repository
   `assg01-lastname` (using your own last name), and set the
...
your changes to the `Feedback` pull request of your GitHub
repository.
...
2. A zip archive of your final repository contents.  You can create
   ...
   `git archive --format=zip --output=assg01-submission.zip main`
